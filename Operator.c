...
void balanceChange(sqlite3 * db, char* sql, char* zErrMsg, int accountNumber, int money)
{
...
void debit(sqlite3 * db, char* sql, char* zErrMsg, int accountNumber, int moneyDebit)
{
	balanceChange(db, sql, zErrMsg, accountNumber, -moneyDebit);
}

void credit(sqlite3 * db, char* sql, char* zErrMsg, int accountNumber, int moneyCredit)
{
	balanceChange(db, sql, zErrMsg, accountNumber, moneyCredit);
}

void transfer(sqlite3 * db, char* sql, char* zErrMsg, int firstUser, int secondUser, int moneyTransfer)
{
	balanceChange(db, sql, zErrMsg, firstUser, -moneyTransfer);
